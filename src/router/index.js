...
const routes = [{
        ...
        children: [{
            ...
            //入库管理
            {
                path: '/inner/purchase',
                component: () =>
                    import ('../views/inner/Purchase.vue'),
                meta: { name1: "入库管理", name2: "采购入库" }
            },
            {
                path: '/inner/check',
                component: () =>
                    import ('../views/inner/Checkin.vue'),
                meta: { name1: "入库管理", name2: "采购入库" }
            },
            {
                path: '/inner/purchaseReco',
                component: () =>
                    import ('../views/inner/InnerSear.vue'),
            ...
            },
            {
                path: '/inner/back',
                component: () =>
                    import ('../views/inner/Back.vue'),
                meta: { name1: "入库管理", name2: "采购退回" }
            },
            {
                path: '/inner/statistics',
                component: () =>
                    import ('../views/inner/InnerStat.vue'),
                meta: { name1: "入库管理", name2: "入库统计" }
            },
            {
                path: '/outer/receipt',
                component: () =>
                    import ('../views/outer/Receipt.vue'),
                meta: { name1: "出库管理", name2: "部门领用" }
            },
            {
                path: '/outer/receiptReco',
                component: () =>
                    import ('../views/outer/Record.vue'),
                meta: { name1: "出库管理", name2: "领用记录" }
            },
            {
                path: '/outer/nowUse',
                component: () =>
                    import ('../views/outer/Receipting.vue'),
...

            {
                ...
                meta: { name1: "退还管理", name2: "正常退还操作" }
            },
            {
                path: '/return/awful',
                component: () =>
                    import ('../views/outer/return/Awful.vue'),
                meta: { name1: "退还管理", name2: "损坏退还操作" }
            },
            {
