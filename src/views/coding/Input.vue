...
<el-card class="box-card">
  <div slot="header" class="clearfix">
      <el-row><input-excel @getResult="getMyExcelData" class="excel"></input-excel>
      <el-button type="primary" plain :disabled="disabled" size="medium" class="import" @click="importData">导入数据库</el-button>
      </el-row>
  </div>
  <div class="text item">
<el-table :data="tableData" border stripe style="width: 100%">
        ...
        <el-table-column label="一级含义" prop="含义">
        </el-table-column>
        <el-table-column label="一级编码" prop="编码">
        </el-table-column>
