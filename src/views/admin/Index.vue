    ...
    <div class="menu" v-bind:style="{ width: menuWStyle }">
      ...
      >
        <el-submenu
          ...
          :index="firstItem.auth_id.toString()"
          :key="firstItem.auth_id"
        >
          <template slot="title">
          ...
          <el-menu-item-group>
            <el-menu-item
              ...
              >{{ twoItem.auth_name }}</el-menu-item
            >
          </el-menu-item-group>
        </el-submenu>
      </el-menu>
...
.admin {
  ...
  display: flex;
  overflow: hidden;
  overflow-x: hidden; // 左侧导航
  .menu {
    width: 200px;
    height: 100%;
    background: #263445;
    overflow: hidden; // TODO. 自己搞动画 :collapse-transition="false"
