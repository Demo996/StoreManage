    ...
    <div class="menu" v-bind:style="{width: menuWStyle}">
        ...
        >
            ...
            <el-submenu index="2">
                ...
                <el-menu-item-group>
                    <el-menu-item index="/inner/purchase" @click="jump('/inner/purchase')"><i class="el-icon-setting"></i>采购入库</el-menu-item>
                    <el-menu-item index="/goods/cate/create" @click="jump('/goods/cate/create')"><i class="el-icon-setting"></i>生产入库</el-menu-item>
                    <el-menu-item index="/goods/cate" @click="jump('/goods/cate')"><i class="el-icon-setting"></i>采购退货</el-menu-item>
                    <el-menu-item index="/goods/cate/create" @click="jump('/goods/cate/create')"><i class="el-icon-setting"></i>入库统计</el-menu-item>
                </el-menu-item-group>
            </el-submenu>
            ...
            <el-submenu index="3">
                ...
                <el-menu-item-group>
                    <el-menu-item index="/goods/type" @click="jump('/goods/type')"><i class="el-icon-setting"></i>部门领用</el-menu-item>
                    <el-menu-item index="/goods/type/create" @click="jump('/goods/type/create')"><i class="el-icon-setting"></i>销售出库</el-menu-item>
                    <el-menu-item index="/goods/attr" @click="jump('/goods/attr')"><i class="el-icon-setting"></i>领用退还</el-menu-item>
                    <el-menu-item index="/goods/attr/create" @click="jump('/goods/attr/create')"><i class="el-icon-setting"></i>出库统计</el-menu-item>
                </el-menu-item-group>
            </el-submenu>
            ...
            <el-submenu index="4">
                ...
                <el-menu-item-group>
                    <el-menu-item index="/goods" @click="jump('/goods')"><i class="el-icon-setting"></i>库存概览</el-menu-item>
                    <el-menu-item index="/goods/create" @click="jump('/goods/create')"><i class="el-icon-setting"></i>编码导入</el-menu-item>
                    <el-menu-item index="/goods/recycle" @click="jump('/goods/recycle')"><i class="el-icon-setting"></i>编码管理</el-menu-item>
                </el-menu-item-group>
            </el-submenu>
