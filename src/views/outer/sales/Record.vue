  ...
  <el-card class="box-card">
    ...
    <div class="text item">
      ...
      >
        ...
        <el-table-column label="单位" prop="单位" width="60"> </el-table-column>

        <el-table-column label="数量" prop="数量" width="50"> </el-table-column>
        ...
        <el-table-column label="客户名称" prop="客户名称" show-overflow-tooltip>
        </el-table-column>
        <el-table-column label="签收人" prop="签收人" show-overflow-tooltip>
        </el-table-column>
        <el-table-column label="出库日期" prop="出库日期" show-overflow-tooltip>
        </el-table-column>
