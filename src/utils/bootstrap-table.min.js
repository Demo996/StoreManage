...
! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e(require("jquery")) : "function" == typeof define && define.amd ? define(["jquery"], e) : (t = t || self).BootstrapTable = e(t.jQuery) }(this, (function(t) {
    ...
    var n = function(t) { return t && t.Math == Math && t },
        ...
        P = {
            f: a ? C : function(t, e) {
                if (t = v(t), e = y(e, !0), O) try { return C(t, e) } catch (t) {}
        ...
        A = {
            f: a ? I : function(t, e, i) {
                if (T(t), e = y(e, !0), T(i), O) try { return I(t, e, i) } catch (t) {}
        ...
        j = o[R] || E(R, {}),
        N = Function.toString;
    "function" != typeof j.inspectSource && (j.inspectSource = function(t) { return N.call(t) });
    ...
    if (L) {
        var Y = new K,
            ...
            X = Y.has,
            Q = Y.set;
        _ = function(t, e) { return Q.call(Y, t, e), e }, F = function(t) { return J.call(Y, t) || {} }, V = function(t) { return X.call(Y, t) }
    } else {
        var Z = W("state");
        G[Z] = !0, _ = function(t, e) { return $(t, Z, e), e }, F = function(t) { return w(t, Z) ? t[Z] : {} }, V = function(t) { return w(t, Z) }
    }
    var tt, et = { set: _, get: F, has: V, enforce: function(t) { return V(t) ? F(t) : _(t, {}) }, getterFor: function(t) { return function(e) { var i; if (!b(e) || (i = F(e)).type !== t) throw TypeError("Incompatible receiver, " + t + " required"); return i } } },
        it = i((function(t) {
            var e = et.get,
                i = et.enforce,
            ...
            })(Function.prototype, "toString", (function() { return "function" == typeof this && e(this).source || D(this) }))
        })),
        nt = o,
        ...
        Ut = function() {
            ...
            var t, e;
            Ut = tt ? function(t) { t.write(Mt("")), t.close(); var e = t.parentWindow.Object; return t = null, e }(tt) : ((e = k("iframe")).style.display = "none", Bt.appendChild(e), e.src = String("javascript:"), (t = e.contentWindow.document).open(), t.write(Mt("document.F=Object")), t.close(), t.F);
            for (var i = yt.length; i--;) delete Ut.prototype[yt[i]];
            return Ut()
        };
    G[Lt] = !0;
    var zt = Object.create || function(t, e) { var i; return null !== t ? (Ht.prototype = T(t), i = new Ht, Ht.prototype = null, i[Lt] = t) : i = Ut(), void 0 === e ? i : Dt(i, e) },
        qt = wt.f,
        Wt = {}.toString,
        ...
        Ee = a && r((function() { return 7 != zt(Se({}, "a", { get: function() { return Se(this, "a", { value: 7 }).a } })).a })) ? function(t, e, i) {
            var n = we(be, e);
        ...
        _e = function(t, e) {
            ...
            var i = v(e),
                n = Vt(i).concat(Be(i));
            return ue(n, (function(e) { a && !Fe.call(i, e) || Ne(t, e, i[e]) })), t
        },
        Fe = function(t) {
            var e = y(t, !0),
                i = ke.call(this, e);
        ...
        Ve = function(t, e) {
            var i = v(t),
                n = y(e, !0);
            if (i !== be || !w(Oe, n) || w(Ce, n)) { var o = we(i, n); return !o || !w(Oe, n) || w(i, de) && i[de][n] || (o.enumerable = !0), o }
        },
        De = function(t) {
            var e = xe(v(t)),
                i = [];
            return ue(e, (function(t) { w(Oe, t) || w(G, t) || i.push(t) })), i
        },
        Be = function(t) {
            var e = t === be,
                i = xe(e ? Ce : v(t)),
                n = [];
            return ue(i, (function(t) {!w(Oe, t) || e && !w(be, t) || n.push(Oe[t]) })), n
        };
    if (jt || (it((ye = function() {
            if (this instanceof ye) throw TypeError("Symbol is not a constructor");
            var t = arguments.length && void 0 !== arguments[0] ? String(arguments[0]) : void 0,
                e = z(t),
                i = function(t) { this === be && i.call(Ce, t), w(this, de) && w(this[de], e) && (this[de][e] = !1), Ee(this, e, h(1, t)) };
            return a && $e && Ee(be, e, { configurable: !0, set: i }), Re(e, t)
        }).prototype, "toString", (function() { return ve(this).tag })), c.f = Fe, A.f = Ne, P.f = Ve, wt.f = Kt.f = De, St.f = Be, a && (Se(ye.prototype, "description", { configurable: !0, get: function() { return ve(this).description } }), it(be, "propertyIsEnumerable", Fe, { unsafe: !0 }))), Nt || (Zt.f = function(t) { return Re(Qt(t), t) }), Rt({ global: !0, wrap: !0, forced: !jt, sham: !jt }, { Symbol: ye }), ue(Vt(Ie), (function(t) { ee(t) })), Rt({ target: pe, stat: !0, forced: !jt }, { for: function(t) { var e = String(t); if (w(Pe, e)) return Pe[e]; var i = ye(e); return Pe[e] = i, Te[i] = e, i }, keyFor: function(t) { if (!je(t)) throw TypeError(t + " is not a symbol"); if (w(Te, t)) return Te[t] }, useSetter: function() { $e = !0 }, useSimple: function() { $e = !1 } }), Rt({ target: "Object", stat: !0, forced: !jt, sham: !a }, { create: function(t, e) { return void 0 === e ? zt(t) : _e(zt(t), e) }, defineProperty: Ne, defineProperties: _e, getOwnPropertyDescriptor: Ve }), Rt({ target: "Object", stat: !0, forced: !jt }, { getOwnPropertyNames: De, getOwnPropertySymbols: Be }), Rt({ target: "Object", stat: !0, forced: r((function() { St.f(1) })) }, { getOwnPropertySymbols: function(t) { return St.f(Ft(t)) } }), me) {
        var Le = !jt || r((function() { var t = ye(); return "[null]" != me([t]) || "{}" != me({ a: t }) || "{}" != me(Object(t)) }));
    ...
    Rt({ target: "Array", proto: !0, forced: !li || !ci }, {
        concat: function(t) {
            ...
            for (e = -1, n = arguments.length; e < n; e++)
                if (hi(r = -1 === e ? a : arguments[e])) { if (l + (o = ht(r.length)) > ai) throw TypeError(si); for (i = 0; i < o; i++, l++) i in r && Xe(s, l, r[i]) } else {
    ...
    Rt({ target: "Array", proto: !0, forced: !di || !pi }, { filter: function(t) { return ui(this, t, arguments.length > 1 ? arguments[1] : void 0) } });
    var fi = Qt("unscopables"),
        gi = Array.prototype;
    null == gi[fi] && A.f(gi, fi, { configurable: !0, value: zt(null) });
    var vi = function(t) { gi[fi][t] = !0 },
        bi = he.find,
        yi = "find",
        mi = !0;
    yi in [] && Array(1).find((function() { mi = !1 })), Rt({ target: "Array", proto: !0, forced: mi }, { find: function(t) { return bi(this, t, arguments.length > 1 ? arguments[1] : void 0) } }), vi(yi);
    var wi = he.findIndex,
        Si = "findIndex",
        xi = !0;
    Si in [] && Array(1).findIndex((function() { xi = !1 })), Rt({ target: "Array", proto: !0, forced: xi }, { findIndex: function(t) { return wi(this, t, arguments.length > 1 ? arguments[1] : void 0) } }), vi(Si);
    var ki = gt.includes;
    Rt({ target: "Array", proto: !0 }, { includes: function(t) { return ki(this, t, arguments.length > 1 ? arguments[1] : void 0) } }), vi("includes");
    var Oi = function(t, e) { var i = [][t]; return !i || !r((function() { i.call(null, e || function() { throw 1 }, 1) })) },
        Ci = gt.indexOf,
        Pi = [].indexOf,
        Ti = !!Pi && 1 / [1].indexOf(1, -0) < 0,
        Ii = Oi("indexOf");
    Rt({ target: "Array", proto: !0, forced: Ti || Ii }, { indexOf: function(t) { return Ti ? Pi.apply(this, arguments) || 0 : Ci(this, t, arguments.length > 1 ? arguments[1] : void 0) } });
    var Ai, $i, Ei, Ri = !r((function() {
        ...
        Fi = Qt("iterator"),
        Vi = !1;
    [].keys && ("next" in (Ei = [].keys()) ? ($i = _i(_i(Ei))) !== Object.prototype && (Ai = $i) : Vi = !0), null == Ai && (Ai = {}), w(Ai, Fi) || $(Ai, Fi, (function() { return this }));
    var Di = { IteratorPrototype: Ai, BUGGY_SAFARI_ITERATORS: Vi },
        ...
        Ki = function(t, e, i, n, o, r, a) {
            ...
            if (b && (s = _i(b.call(new t)), Hi !== Object.prototype && s.next && (_i(s) !== Hi && (Li ? Li(s, Hi) : "function" != typeof s[Ui] && $(s, Ui, Gi)), oe(s, d, !0))), o == qi && g && g.name !== qi && (p = !0, v = function() { return g.call(this) }), f[Ui] !== v && $(f, Ui, v), o)
        ...
        Ji = et.set,
        Xi = et.getterFor(Yi),
        Qi = Ki(Array, "Array", (function(t, e) { Ji(this, { type: Yi, target: v(t), index: 0, kind: e }) }), (function() {
            var t = Xi(this),
                e = t.target,
                i = t.kind,
                n = t.index++;
    ...
    var Zi = [].join,
        tn = f != Object,
        en = Oi("join", ",");
    Rt({ target: "Array", proto: !0, forced: tn || en }, { join: function(t) { return Zi.call(v(this), void 0 === t ? "," : t) } });
    var nn = he.map,
        on = oi("map"),
        rn = on && !r((function() {
            [].map.call({ length: -1, 0: 1 }, (function(t) { throw t }))
        }));
    Rt({ target: "Array", proto: !0, forced: !on || !rn }, { map: function(t) { return nn(this, t, arguments.length > 1 ? arguments[1] : void 0) } });
    var an = [].reverse,
        sn = [1, 2];
    Rt({ target: "Array", proto: !0, forced: String(sn) === String(sn.reverse()) }, { reverse: function() { return _t(this) && (this.length = this.length), an.call(this) } });
    var ln = Qt("species"),
        cn = [].slice,
        hn = Math.max;
    ...
    var un = [],
        ...
        gn = Oi("sort");
    Rt({ target: "Array", proto: !0, forced: pn || !fn || gn }, { sort: function(t) { return void 0 === t ? dn.call(Ft(this)) : dn.call(Ft(this), re(t)) } });
    var vn = Math.max,
        bn = Math.min,
        yn = 9007199254740991,
    ...
    var wn = function(t, e, i) { var n, o; return Li && "function" == typeof(n = e.constructor) && n !== i && b(o = n.prototype) && o !== i.prototype && Li(t, o), t },
        Sn = "\t\n\v\f\r                　\u2028\u2029\ufeff",
        xn = "[" + Sn + "]",
        kn = RegExp("^" + xn + xn + "*"),
        On = RegExp(xn + xn + "*$"),
        ...
        _n = function(t) {
            ...
            if ("string" == typeof c && c.length > 2)
                if (43 === (e = (c = $n(c)).charCodeAt(0)) || 45 === e) { if (88 === (i = c.charCodeAt(2)) || 120 === i) return NaN } else if (48 === e) {
    ...
    if ($t(En, !Rn(" 0o1") || !Rn("0b1") || Rn("+0x1"))) {
        for (var Fn, Vn = function(t) {
                var e = arguments.length < 1 ? 0 : t,
                    i = this;
                return i instanceof Vn && (Nn ? r((function() { jn.valueOf.call(i) })) : d(i) != En) ? wn(new Rn(_n(e)), i, Vn) : _n(e)
    ...
    var Ln = Object.assign,
        ...
        Mn = !Ln || r((function() {
            if (a && 1 !== Ln({ b: 1 }, Ln(Hn({}, "a", { enumerable: !0, get: function() { Hn(this, "b", { value: 3, enumerable: !1 }) } }), { b: 2 })).b) return !0;
            var t = {},
                e = {},
                i = Symbol(),
                n = "abcdefghijklmnopqrst";
            return t[i] = 7, n.split("").forEach((function(t) { e[t] = t })), 7 != Ln({}, t)[i] || Vt(Ln({}, e)).join("") != n
        })) ? function(t, e) {
    ...
    Rt({ target: "Object", stat: !0 }, { entries: function(t) { return qn(t) } });
    var Wn = {};
    Wn[Qt("toStringTag")] = "z";
    ...
    function lo(t, e) { return RegExp(t, e) }
    var co = { UNSUPPORTED_Y: r((function() { var t = lo("a", "y"); return t.lastIndex = 2, null != t.exec("abcd") })), BROKEN_CARET: r((function() { var t = lo("^r", "gy"); return t.lastIndex = 2, null != t.exec("str") })) },
        ho = Qt("species"),
        uo = A.f,
        po = wt.f,
        fo = et.set,
        ...
        wo = new vo(yo) !== yo,
        So = co.UNSUPPORTED_Y;
    if (a && $t("RegExp", !wo || So || r((function() { return mo[go] = !1, vo(yo) != yo || vo(mo) == mo || "/a/i" != vo(yo, "i") })))) {
        for (var xo = function(t, e) {
            ...
            }, ko = function(t) { t in xo || uo(xo, t, { configurable: !0, get: function() { return vo[t] }, set: function(e) { vo[t] = e } }) }, Oo = po(vo), Co = 0; Oo.length > Co;) ko(Oo[Co++]);
        bo.constructor = xo, xo.prototype = bo, it(o, "RegExp", xo)
    }! function(t) {
        var e = rt(t),
            i = A.f;
        a && e && !e[ho] && i(e, ho, { configurable: !0, get: function() { return this } })
    }("RegExp");
    ...
    var Do = function(t) { if (ao(t)) throw TypeError("The method doesn't accept regular expressions"); return t },
        Bo = Qt("match"),
        Lo = function(t) { var e = /./; try { "/./" [t](e) } catch (i) { try { return e[Bo] = !1, "/./" [t](e) } catch (t) {} } return !1 };
    Rt({ target: "String", proto: !0, forced: !Lo("includes") }, { includes: function(t) { return !!~String(g(this)).indexOf(Do(t), arguments.length > 1 ? arguments[1] : void 0) } });
    var Ho = function(t) {
            return function(e, i) {
        ...
        qo = et.set,
        Wo = et.getterFor(zo);
    Ki(String, "String", (function(t) { qo(this, { type: zo, string: String(t), index: 0 }) }), (function() {
        var t, e = Wo(this),
            i = e.string,
            n = e.index;
        ...
        Xo = function(t, e, i, n) {
            var o = Qt(t),
                ...
                s = a && !r((function() {
                    var e = !1,
                        i = /a/;
                    return "split" === t && ((i = {}).constructor = {}, i.constructor[Go] = function() { return i }, i.flags = "", i[o] = /./ [o]), i.exec = function() { return e = !0, null }, i[o](""), !e
                }));
    ...
    Xo("replace", 2, (function(t, e, i, n) {
        return [function(i, n) {
            ...
            for (var d = [];;) { var p = tr(s, l); if (null === p) break; if (d.push(p), !h) break; "" === String(p[0]) && (s.lastIndex = Zo(l, ht(s.lastIndex), u)) }
            ...
            return void 0 !== r && (r = Ft(r), c = or), e.call(a, c, (function(e, a) {
                ...
                switch (a.charAt(0)) {
                    ...
                    default:
                        var h = +a;
                        if (0 === h) return e;
                        if (h > l) { var u = nr(h / 10); return 0 === u ? e : u <= l ? void 0 === o[u - 1] ? a.charAt(1) : o[u - 1] + a.charAt(1) : e }
                        c = o[h - 1]
                }
                return void 0 === c ? "" : c
            }))
    ...
    var ar = Object.is || function(t, e) { return t === e ? 0 !== t || 1 / t == 1 / e : t != t && e != e };
    ...
    var dr = Pn.trim;
    Rt({ target: "String", proto: !0, forced: function(t) { return r((function() { return !!Sn[t]() || "​᠎" != "​᠎" [t]() || Sn[t].name !== t })) }("trim") }, { trim: function() { return dr(this) } });
    var pr = { CSSRuleList: 0, CSSStyleDeclaration: 0, CSSValueList: 0, ClientRectList: 0, DOMRectList: 0, DOMStringList: 0, DOMTokenList: 1, DataTransferItemList: 0, FileList: 0, HTMLAllCollection: 0, HTMLCollection: 0, HTMLFormElement: 0, HTMLSelectElement: 0, MediaList: 0, MimeTypeArray: 0, NamedNodeMap: 0, NodeList: 1, PaintRequestList: 0, Plugin: 0, PluginArray: 0, SVGLengthList: 0, SVGNumberList: 0, SVGPathSegList: 0, SVGPointList: 0, SVGStringList: 0, SVGTransformList: 0, SourceBufferList: 0, StyleSheetList: 0, TextTrackCueList: 0, TextTrackList: 0, TouchList: 0 },
        fr = he.forEach,
        gr = Oi("forEach") ? function(t) { return fr(this, t, arguments.length > 1 ? arguments[1] : void 0) } : [].forEach;
    for (var vr in pr) {
        var br = o[vr],
            yr = br && br.prototype;
        if (yr && yr.forEach !== gr) try { $(yr, "forEach", gr) } catch (t) { yr.forEach = gr }
    }
    var mr = Qt("iterator"),
        wr = Qt("toStringTag"),
        Sr = Qi.values;
    for (var xr in pr) {
        var kr = o[xr],
            Or = kr && kr.prototype;
        if (Or) {
            if (Or[mr] !== Sr) try { $(Or, mr, Sr) } catch (t) { Or[mr] = Sr }
    ...
    var _r = { 3: { iconsPrefix: "fa", icons: { paginationSwitchDown: "glyphicon-collapse-down icon-chevron-down", paginationSwitchUp: "glyphicon-collapse-up icon-chevron-up", refresh: "fa-refresh", toggleOff: "fa fa-toggle-off", toggleOn: "fa fa-toggle-on", columns: "fa fa-list", detailOpen: "glyphicon-plus icon-plus", detailClose: "glyphicon-minus icon-minus", fullscreen: "glyphicon-fullscreen", search: "glyphicon-search", clearSearch: "glyphicon-trash" }, classes: { buttonsPrefix: "btn", buttons: "default", buttonsGroup: "btn-group", buttonsDropdown: "btn-group", pull: "pull", inputGroup: "input-group", inputPrefix: "input-", input: "form-control", paginationDropdown: "btn-group dropdown", dropup: "dropup", dropdownActive: "active", paginationActive: "active", buttonActive: "active" }, html: { toolbarDropdown: ['<ul class="dropdown-menu" role="menu">', "</ul>"], toolbarDropdownItem: '<li class="dropdown-item-marker" role="menuitem"><label>%s</label></li>', toolbarDropdownSeparator: '<li class="divider"></li>', pageDropdown: ['<ul class="dropdown-menu" role="menu">', "</ul>"], pageDropdownItem: '<li role="menuitem" class="%s"><a href="#">%s</a></li>', dropdownCaret: '<span class="caret"></span>', pagination: ['<ul class="pagination%s">', "</ul>"], paginationItem: '<li class="page-item%s"><a class="page-link" aria-label="%s" href="javascript:void(0)">%s</a></li>', icon: '<i class="%s %s"></i>', inputGroup: '<div class="input-group">%s<span class="input-group-btn">%s</span></div>', searchInput: '<input class="%s%s" type="text" placeholder="%s">', searchButton: '<button class="%s" type="button" name="search" title="%s">%s %s</button>', searchClearButton: '<button class="%s" type="button" name="clearSearch" title="%s">%s %s</button>' } }, 4: { iconsPrefix: "fa", icons: { paginationSwitchDown: "fa-caret-square-down", paginationSwitchUp: "fa-caret-square-up", refresh: "fa-refresh", toggleOff: "fa-toggle-off", toggleOn: "fa-toggle-on", columns: "fa-list", detailOpen: "fa-plus", detailClose: "fa-minus", fullscreen: "fa-arrows-alt", search: "fa-search", clearSearch: "fa-trash" }, classes: { buttonsPrefix: "btn", buttons: "secondary", buttonsGroup: "btn-group", buttonsDropdown: "btn-group", pull: "float", inputGroup: "btn-group", inputPrefix: "form-control-", input: "form-control", paginationDropdown: "btn-group dropdown", dropup: "dropup", dropdownActive: "active", paginationActive: "active", buttonActive: "active" }, html: { toolbarDropdown: ['<div class="dropdown-menu dropdown-menu-right">', "</div>"], toolbarDropdownItem: '<label class="dropdown-item dropdown-item-marker">%s</label>', pageDropdown: ['<div class="dropdown-menu">', "</div>"], pageDropdownItem: '<a class="dropdown-item %s" href="#">%s</a>', toolbarDropdownSeparator: '<div class="dropdown-divider"></div>', dropdownCaret: '<span class="caret"></span>', pagination: ['<ul class="pagination%s">', "</ul>"], paginationItem: '<li class="page-item%s"><a class="page-link" aria-label="%s" href="javascript:void(0)">%s</a></li>', icon: '<i class="%s %s"></i>', inputGroup: '<div class="input-group">%s<div class="input-group-append">%s</div></div>', searchInput: '<input class="%s%s" type="text" placeholder="%s">', searchButton: '<button class="%s" type="button" name="search" title="%s">%s %s</button>', searchClearButton: '<button class="%s" type="button" name="clearSearch" title="%s">%s %s</button>' } }, 5: { iconsPrefix: "fa", icons: { paginationSwitchDown: "fa-caret-square-down", paginationSwitchUp: "fa-caret-square-up", refresh: "fa-refresh", toggleOff: "fa-toggle-off", toggleOn: "fa-toggle-on", columns: "fa-list", detailOpen: "fa-plus", detailClose: "fa-minus", fullscreen: "fa-arrows-alt", search: "fa-search", clearSearch: "fa-trash" }, classes: { buttonsPrefix: "btn", buttons: "secondary", buttonsGroup: "btn-group", buttonsDropdown: "btn-group", pull: "float", inputGroup: "btn-group", inputPrefix: "form-control-", input: "form-control", paginationDropdown: "btn-group dropdown", dropup: "dropup", dropdownActive: "active", paginationActive: "active", buttonActive: "active" }, html: { toolbarDropdown: ['<div class="dropdown-menu dropdown-menu-right">', "</div>"], toolbarDropdownItem: '<label class="dropdown-item dropdown-item-marker">%s</label>', pageDropdown: ['<div class="dropdown-menu">', "</div>"], pageDropdownItem: '<a class="dropdown-item %s" href="#">%s</a>', toolbarDropdownSeparator: '<div class="dropdown-divider"></div>', dropdownCaret: '<span class="caret"></span>', pagination: ['<ul class="pagination%s">', "</ul>"], paginationItem: '<li class="page-item%s"><a class="page-link" aria-label="%s" href="javascript:void(0)">%s</a></li>', icon: '<i class="%s %s"></i>', inputGroup: '<div class="input-group">%s<div class="input-group-append">%s</div></div>', searchInput: '<input class="%s%s" type="text" placeholder="%s">', searchButton: '<button class="%s" type="button" name="search" title="%s">%s %s</button>', searchClearButton: '<button class="%s" type="button" name="clearSearch" title="%s">%s %s</button>' } } }[Rr],
        ...
        Vr = { formatLoadingMessage: function() { return "Loading, please wait" }, formatRecordsPerPage: function(t) { return "".concat(t, " rows per page") }, formatShowingRows: function(t, e, i, n) { return void 0 !== n && n > 0 && n > i ? "显示 ".concat(t, " 到 ").concat(e, " 共 ").concat(i, " rows (filtered from ").concat(n, " total rows)") : "显示 ".concat(t, " 到 ").concat(e, " 共 ").concat(i, " 行") }, formatSRPaginationPreText: function() { return "previous page" }, formatSRPaginationPageText: function(t) { return "到 page ".concat(t) }, formatSRPaginationNextText: function() { return "next page" }, formatDetailPagination: function(t) { return "显示 ".concat(t, " 行") }, formatSearch: function() { return "Search" }, formatClearSearch: function() { return "Clear Search" }, formatNoMatches: function() { return "No matching records found" }, formatPaginationSwitch: function() { return "Hide/Show pagination" }, formatPaginationSwitchDown: function() { return "Show pagination" }, formatPaginationSwitchUp: function() { return "Hide pagination" }, formatRefresh: function() { return "Refresh" }, formatToggle: function() { return "Toggle" }, formatToggleOn: function() { return "Show card view" }, formatToggleOff: function() { return "Hide card view" }, formatColumns: function() { return "Columns" }, formatColumnsToggleAll: function() { return "Toggle all" }, formatFullscreen: function() { return "Fullscreen" }, formatAllRows: function() { return "All" } },
    ...
    var Qr = {
            getSearchInput: function(e) { return "string" == typeof e.options.searchSelector ? t(e.options.searchSelector) : e.$toolbar.find(".search input") },
            sprintf: function(t) {
            ...
            isObject: function(t) { return t instanceof Object && !Array.isArray(t) },
            ...
            normalizeAccent: function(t) { return "string" != typeof t ? t : t.normalize("NFD").replace(/[\u0300-\u036f]/g, "") },
            ...
            calculateObjectValue: function(t, e) {
                ...
                if ("string" == typeof e) {
                    ...
                    if (r.length > 1) {
                        ...
                        } catch (t) { s = !0, l = t } finally { try { a || null == h.return || h.return() } finally { if (s) throw l } }
                    } else o = window[e]
                }
            ...
            getEventName: function(t) { var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : ""; return e = e || "".concat(+new Date).concat(~~(1e6 * Math.random())), "".concat(t, "-").concat(e) },
            hasDetailViewIcon: function(t) { return t.detailView && t.detailViewIcon && !t.cardView },
            getDetailViewIndexOffset: function(t) { return this.hasDetailViewIcon(t) && "right" !== t.detailViewAlign ? 1 : 0 },
            ...
            deepCopy: function(e) { return void 0 === e ? e : t.extend(!0, Array.isArray(e) ? [] : {}, e) }
        },
        Zr = function() {
            function t(e) {
                var i = this;
        ...
        ta = function() {
            function e(i, n) { Tr(this, e), this.options = n, this.$el = t(i), this.$el_ = this.$el.clone(), this.timeoutId_ = 0, this.timeoutFooter_ = 0 }
            return Ar(e, [{ key: "init", value: function() { this.initConstants(), this.initLocale(), this.initContainer(), this.initTable(), this.initHeader(), this.initData(), this.initHiddenRows(), this.initToolbar(), this.initPagination(), this.initBody(), this.initSearchText(), this.initServer() } }, {
                key: "initConstants",
                value: function() {
                    var e = this.options;
                ...
                value: function() {
                    var e = this,
                        i = {},
                        n = [];
                    this.header = { fields: [], styles: [], classes: [], formatters: [], detailFormatters: [], events: [], sorters: [], sortNames: [], cellStyles: [], searchables: [] }, Qr.updateFieldGroup(this.options.columns), this.options.columns.forEach((function(t, o) {
            ...
            }, { key: "initData", value: function(t, e) { "append" === e ? this.options.data = this.options.data.concat(t) : "prepend" === e ? this.options.data = [].concat(t).concat(this.options.data) : (t = t || Qr.deepCopy(this.options.data), this.options.data = Array.isArray(t) ? t : t[this.options.dataField]), this.data = Er(this.options.data), this.options.sortReset && (this.unsortedData = Er(this.data)), "server" !== this.options.sidePagination && this.initSort() } }, {
                key: "initSort",
                value: function() {
                    var t = this,
                        ...
                        o = 0; - 1 !== n ? (this.options.sortStable && this.data.forEach((function(t, e) { t.hasOwnProperty("_position") || (t._position = e) })), this.options.customSort ? Qr.calculateObjectValue(this.options, this.options.customSort, [this.options.sortName, this.options.sortOrder, this.data]) : this.data.sort((function(o, r) {
                ...
                value: function() {
                    ...
                    } catch (t) { k = !0, O = t } finally { try { x || null == P.return || P.return() } finally { if (k) throw O } }
                    ...
                    for (var I = 0, A = Object.entries(this.buttons); I < A.length; I++) {
                        ...
                        if (R.hasOwnProperty("event")) {
                            ...
                            for (var j = function() {
                                    ...
                                    i.$toolbar.find('button[name="'.concat(E, '"]')).off(e).on(e, (function() { return o.call(i) }))
                    ...
                    if (n.showColumns) {
                        ...
                        if (a <= n.minimumCountColumns && e.find("input").prop("disabled", !0), e.find("li, label").off("click").on("click", (function(t) { t.stopImmediatePropagation() })), F.off("click").on("click", (function(e) {
                                var n = e.currentTarget,
                                    o = t(n);
                                i._toggleColumn(o.val(), o.prop("checked"), !1), i.trigger("column-switch", o.data("field"), o.prop("checked")), V.prop("checked", F.filter(":checked").length === i.columns.filter((function(t) { return !i.isSelectionColumn(t) })).length)
                    ...
                    var L = function(t) {
                        ...
                        t.off(e).on(e, (function(t) { n.searchOnEnterKey && 13 !== t.keyCode || [37, 38, 39, 40].includes(t.keyCode) || (clearTimeout(r), r = setTimeout((function() { i.onSearch({ currentTarget: t.currentTarget }) }), n.searchTimeOut)) }))
                    };
                    if ((n.search || this.showSearchClearButton) && "string" != typeof n.searchSelector) {
                        ...
                        n.showSearchButton ? (this.$toolbar.find(".search button[name=search]").off("click").on("click", (function(t) { clearTimeout(r), r = setTimeout((function() { i.onSearch({ currentTarget: W }) }), n.searchTimeOut) })), n.searchOnEnterKey && L(W)) : L(W), n.showSearchClearButton && this.$toolbar.find(".search button[name=clearSearch]").click((function() { i.resetSearch() }))
                    } else if ("string" == typeof n.searchSelector) { L(Qr.getSearchInput(this)) }
                }
            }, {
                key: "onSearch",
                value: function() {
                    ...
                    if (e.pagination) {
                        ...
                        if ((this.paginationParts.includes("pageInfo") || this.paginationParts.includes("pageInfoShort") || this.paginationParts.includes("pageSize")) && c.push("</span></div>"), this.paginationParts.includes("pageList")) {
                            ...
                            var g = Math.round(e.paginationPagesBySide / 2),
                                v = function(i) { var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : ""; return Qr.sprintf(t.constants.html.paginationItem, n + (i === e.pageNumber ? " ".concat(t.constants.classes.paginationActive) : ""), e.formatSRPaginationPageText(i), i) };
                            if (n > 1) {
                ...
                value: function() {
                    ...
                    })).off("mousedown").on("mousedown", (function(t) { e.multipleSelectRowCtrlKey = t.ctrlKey || t.metaKey, e.multipleSelectRowShiftKey = t.shiftKey })), this.$body.find("> tr[data-index] > td > .detail-icon").off("click").on("click", (function(i) { return i.preventDefault(), e.toggleDetailView(t(i.currentTarget).parent().parent().data("index")), !1 })), this.$selectItem = this.$body.find(Qr.sprintf('[name="%s"]', this.options.selectItemName)), this.$selectItem.off("click").on("click", (function(i) {
                ...
                value: function() {
                    ...
                    if (this.$el.is(":hidden")) this.timeoutId_ = setTimeout((function() { return e.fitHeader() }), 100);
                        ...
                        l.length > 0 && (l.focus(), this.$header.find(".focus-temp").removeClass("focus-temp")), this.$header.find("th[data-field]").each((function(i, n) { e.$header_.find(Qr.sprintf('th[data-field="%s"]', t(n).data("field"))).data(t(n).data()) }));
            ...
            }, { key: "initHiddenRows", value: function() { this.hiddenRows = [] } }, { key: "getOptions", value: function() { var e = t.extend({}, this.options); return delete e.data, t.extend(!0, {}, e) } }, { key: "refreshOptions", value: function(e) { Qr.compareObjects(this.options, e, !0) || (this.options = t.extend(this.options, e), this.trigger("refresh-options", this.options), this.destroy(), this.init()) } }, {
                key: "getData",
                value: function(t) {
                    var e = this,
                        i = this.options.data;
                    if (!this.searchText && !this.options.customSearch && void 0 === this.options.sortName && Qr.isEmptyObject(this.filterColumns) && Qr.isEmptyObject(this.filterColumnsPartial) || t && t.unfiltered || (i = this.data), t && t.useCurrentPage && (i = i.slice(this.pageFrom - 1, this.pageTo)), t && !t.includeHiddenRows) {
                        ...
                        i = i.filter((function(t) { return -1 === Qr.findIndex(n, t) }))
                    }
            ...
            }, { key: "getSelections", value: function() { var t = this; return this.options.data.filter((function(e) { return !0 === e[t.header.stateField] })) } }, {
                key: "load",
                value: function(t) {
                    var e, i = t;
